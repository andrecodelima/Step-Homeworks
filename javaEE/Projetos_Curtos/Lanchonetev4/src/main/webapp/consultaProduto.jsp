...
<%
	...
	if(lista.isEmpty()){
		...
		for(Produto p : lista){
			...
			line +=	"<tr>"		+
							...
							"<td class='Dados'>"	+	p.getNome()			+			"</td>"		+
							"<td class='Dados'>"	+	p.getDescricao()	+			"</td>"		+
							"<td class='Dados'>"	+	p.getPreco()		+			"</td>"		+
	...
	ArrayList<Produto> listaProduto = ProdutoServiceImplementation.getProduto();
	String lines = "";
	
	FileWriter doc 		= new FileWriter("C:\\java\\saidas\\Produto.txt");
	PrintWriter write	= new PrintWriter(doc);
	
	
	for(Produto p : listaProduto){
		write.println(p.getNome() + " | " + p.getDescricao() + " | " + p.getPreco() + " | ");
	}
	
	doc.close();
	write.close();
	
	FileReader doc1 = new FileReader("C:\\java\\saidas\\Produto.txt");
	BufferedReader read = new BufferedReader(doc1);
	
	
	ArrayList<Produto> listaProdutoLida = new ArrayList<Produto>();
	String Produto = read.readLine();
...
<body>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
				          ...
				          <ul class="dropdown-menu">
				           	<li><a class="dropdown-item" href="Produto.jsp">Produtos</a></li>
				      		<li><a class="dropdown-item" href="cadastroProduto.html">Cadastro de Produtos</a></li>
				            <li><a class="dropdown-item" href="consultaProduto.jsp">Consulta de Produto</a></li>
				          </ul>
				        </li>
	...
	<main class="main-default">
		...
		<section class="box-produtos">
			...
			<form action="consultaProduto.jsp">
