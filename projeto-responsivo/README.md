...
`%` - Porcentagem
`auto` - Automática
`vh` - Viewport Height - 0 a 100 (parecido com %)
`vw` - Viewport Width - 0 a 100 ()
...
ex:
ul{14px} (ul - Elemento pai)
li(2em) (li- elemento filho, que nesse caso terá duas vezes o valor do pai)
`rem` - multiplicado pelo root
root é a tag principal - html
