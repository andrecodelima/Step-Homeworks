...
var InputNomeP       = document.getElementById('inputProfNome')
var inputSobrenomeP  = document.getElementById('inputProfSobrenome')
var inputIdadeP      = document.getElementById('inputProfIdade')
var inputCursoP      = document.getElementById('inputProfCurso')
var inputTurnoP      = document.getElementById('inputProfTurno')
...
function cadastrarProfessores(){
    ...
    bancoProfessores.push(new cadastroProfessor(InputNomeP.value, 
                                          inputSobrenomeP.value,
                                          inputIdadeP.value,
                                          inputCursoP.value,
                                          inputTurnoP.value
...
var InputNomeT       = document.getElementById('inputTurmaNome')
var inputTurnoT      = document.getElementById('inputTurmaTurno')

function cadastrarTurmas(){
    let form                = document.getElementById('formTurma')

    bancoTurma.push(new cadastroTurma(InputNomeT.value, 
                                      inputTurnoT.value
                ))



    if(inputTurnoT.value == 'Manhã'){
        TurnoManha.push(new cadastroTurma(InputNomeT.value, 
                                            inputTurnoT.value       
                                          ))
        
        
    }else if(inputTurnoT.value  == 'Tarde'){
        TurnoTarde.push(new cadastroTurma(InputNomeT.value, 
                                          inputTurnoT.value
                                          ))

    }else if(inputTurnoT.value  == 'Noite'){
        TurnoNoite.push(new cadastroTurma(InputNomeT.value, 
                                          inputTurnoT.value
                                          ))
    }
